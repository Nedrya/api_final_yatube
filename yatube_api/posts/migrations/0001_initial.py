# Generated by Django 2.2.16 on 2022-06-06 06:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('сomment', models.ForeignKey(blank=True, help_text='Коментарии к  посту', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='posts.Comment', verbose_name='Коментарии')),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
